  ...
  return (
    <section id="home" className="w-[95%] max-w-[1440px] mx-auto pt-20">
      <div className="bg-gradient-to-l from-sky-900 to-black rounded-[32px] overflow-hidden relative">
        ...
        {/* Bottom gradient */}
               <div className="absolute bottom-0 left-0 right-0 h-48 w-full bg-[radial-gradient(ellipse_64.40%_50.00%_at_50.00%_50.00%,_black_78%,_#00457F_100%)] rounded-t-[130px] blur-[5px]" />
